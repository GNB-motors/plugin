...
(function() {
  ...
  XMLHttpRequest.prototype.send = function(body) {
    if (this._interceptedToken) {
      ...
      } catch(e) { console.debug('[FleetEdge Interceptor] Parsing error:', e); }
      window.postMessage({ type: 'FLEETEDGE_INTERCEPT', token: this._interceptedToken, fleetId }, '*');
    }
  ...
  window.fetch = async function(...args) {
    ...
    } catch(e) { console.debug('[FleetEdge Interceptor] Fetch error:', e); }
